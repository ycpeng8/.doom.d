...
;; Set font
;; (setq doom-font (font-spec :family "Terminus (TTF)" :size 16 :weight 'bold)
;;    doom-variable-pitch-font (font-spec :family "Terminus (TTF)" :size 14 :weight 'bold))
